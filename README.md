...
- removeItem(itemId: string): void — удаляет товар из корзины по его уникальному идентификатору и обновляет общую сумму.
- clearBasket(): void — очищает корзину.
- getTotalPrice(): number — возвращает общую сумму стоимости товаров в корзине.
